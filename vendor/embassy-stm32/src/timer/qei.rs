...
impl<'d, T: GeneralInstance4Channel, C: QeiChannel> QeiPin<'d, T, C> {
    ...
    /// Create a new QEI pin instance with an explicit GPIO pull configuration.
    ///
    /// This is useful for open-collector encoder outputs which require pull-ups.
    pub fn new_with_pull(pin: Peri<'d, impl TimerPin<T, C>>, pull: Pull) -> Self {
